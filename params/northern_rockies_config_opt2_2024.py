...
# AOI
param['aoi'] = ee.FeatureCollection("projects/r6-bugnet/assets/northern_rockies/bugnet_Columbia_Mountains_Northern_Rockies")
...
param['version'] = 'v1'
param['region'] = 'northern_rockies'

# Working directories  # if your area is spatially large these should be different locations
param['assetDir'] = "projects/r6-bugnet/assets/northern_rockies/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
param['LTSDdir'] = "projects/r6-bugnet/assets/northern_rockies/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
