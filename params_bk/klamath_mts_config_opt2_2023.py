...
# AOI
param['aoi'] = ee.FeatureCollection("projects/r6-bugnet/assets/klamath_mts/bugnet_Klamath_Mountains")
...
param['version'] = 'v1'
param['region'] = 'klamath_mts'

# Working directories  # if your area is spatially large these should be different locations
param['assetDir'] = "projects/r6-bugnet/assets/klamath_mts/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
param['LTSDdir'] = "projects/r6-bugnet/assets/klamath_mts/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
