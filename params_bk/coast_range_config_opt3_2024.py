...
# AOI
param['aoi'] = ee.FeatureCollection("projects/r6-bugnet/assets/coast_range/bugnet_Coast_Range")
...
param['version'] = 'v1'
param['region'] = 'coast_range'

# Working directories  # if your area is spatially large these should be different locations
param['assetDir'] = "projects/r6-bugnet/assets/coast_range/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
param['LTSDdir'] = "projects/r6-bugnet/assets/coast_range/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
