...
# AOI
param['aoi'] = ee.FeatureCollection("projects/r6-bugnet/assets/cascades/bugnet_Cascades")
...
param['version'] = 'v1'
param['region'] = 'cascades'

# Working directories  # if your area is spatially large these should be different locations
param['assetDir'] = "projects/r6-bugnet/assets/cascades/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
param['LTSDdir'] = "projects/r6-bugnet/assets/cascades/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
