...
param['project_name'] = 'sse-alaska-bugnet'
...
param['target'] = 2024
param['aoi'] = ee.FeatureCollection("USGS/WBD/2017/HUC06").filter(ee.Filter.eq('name','Southern Southeast Alaska'))
