...
param['project_name'] = 'cse-alaska-bugnet'
ee.Initialize(project=param['project_name'])

param["platform"] = 'LS' 
param['ltstartYear'] = 2000
param['ltendYear'] = 2024
param['aoi'] = ee.FeatureCollection("USGS/WBD/2017/HUC06").filter(ee.Filter.eq('name','Central Southeast Alaska'))
