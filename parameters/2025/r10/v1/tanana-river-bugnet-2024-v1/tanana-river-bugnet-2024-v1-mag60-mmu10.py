...
param = {}
param['project_name'] = 'tanana-river-bugnet'
...
param['target'] = 2025
param['aoi'] = ee.FeatureCollection("USGS/WBD/2017/HUC06").filter(ee.Filter.eq('name','Tanana River'))
...
param['subregion']= 'tanana-river'
param['sub_region']= 'tanana-river'
