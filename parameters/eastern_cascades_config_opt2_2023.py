...
# AOI
param['aoi'] = ee.FeatureCollection("projects/r6-bugnet/assets/eastern_cascades/bugnet_Eastern_Cascades_Slopes_and_Foothills")
...
param['version'] = 'v1'
param['region'] = 'eastern-cascades'

# Working directories  # if your area is spatially large these should be different locations
param['assetDir'] = "projects/r6-bugnet/assets/eastern_cascades/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
param['LTSDdir'] = "projects/r6-bugnet/assets/eastern_cascades/"  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
