...
## AOI
param['aoi'] = ee.FeatureCollection(ee.FeatureCollection('EPA/Ecoregions/2013/L3').filter(ee.Filter.eq('na_l3name','Coast Range')).geometry().intersection(ee.FeatureCollection("TIGER/2016/States").filter(ee.Filter.Or(ee.Filter.eq('NAME','Oregon'),ee.Filter.eq('NAME','Washington')))))
