...
param['project_name'] = 'chicken-creek-or-s2-10-bnet'
ee.Initialize(project=param['project_name'])
param['configName'] = 'option3'
param['aoi'] = ee.FeatureCollection('projects/chicken-creek-or-s2-10-bnet/assets/chickenCreek')
...
param['target'] = 2024
param['decline_thresholds'] = {'B2':(0,0),'B3':(5,5)}
param['decline_template'] = '{B2} && {B3}'
