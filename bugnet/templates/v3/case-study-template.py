...
param['project_name'] = 'clarype-general'
ee.Initialize(project=param['project_name'])
param["platform"] = 'S2-10'
param['ltstartYear'] = 2000
param['ltendYear'] = 2025
param['target'] = 2025
param['aoi'] = ee.FeatureCollection('projects/clarype-general/assets/boundingbox')
...
param['subregion']= 'clarype-general'
param['sub_region']="clarype-general"
